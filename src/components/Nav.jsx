...
const Nav = () => {
  return (
    <nav class="navbar navbar-expand-lg bg-light">
        <div class="container">
            <a class="navbar-brand" href="#">pro:manage</a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <form class="d-flex me-auto" role="search">
                    <input class="form-control me-2 border-0" type="search" placeholder="Type to find something here..." aria-label="Search" style={{fontSize: '14px', color: '#f5f5f5', width: '330px', backgroundColor: '#f5f5f5'}}/>
                    <i class='align-middle' style={{fontSize: '18px', cursor: 'pointer'}} >
                        <BiSearch />
                    </i>
                </form>


                <ul class="navbar-nav mb-2 mb-lg-0" style={{fontSize: '14px'}}>
                    <li class="nav-item">
